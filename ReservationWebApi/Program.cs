...
namespace ReservationWebApi
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IReservationDetailRepoAsync,EFReservationDetailRepoAsync>(); 
            builder.Services.AddScoped<IReservationMasterRepoAsync,EFReservationMasterRepoAsync>();
